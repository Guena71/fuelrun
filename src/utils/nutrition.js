...
export function calcNutrition(profile,sessType){
  ...
  var mults={easy:1.5,interval:1.7,tempo:1.65,long:1.9,recovery:1.3,rest:1.2,race:2.1,strength:1.45};
  var macros={easy:{c:0.55,p:0.20,f:0.25},interval:{c:0.55,p:0.25,f:0.20},tempo:{c:0.57,p:0.22,f:0.21},long:{c:0.65,p:0.15,f:0.20},recovery:{c:0.45,p:0.30,f:0.25},rest:{c:0.40,p:0.30,f:0.30},race:{c:0.70,p:0.15,f:0.15},strength:{c:0.40,p:0.35,f:0.25}};
